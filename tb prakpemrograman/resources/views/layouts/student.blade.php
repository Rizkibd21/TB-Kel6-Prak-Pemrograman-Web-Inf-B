...
<head>
    ...
    <title>SIAkad Core - Student Console</title>
    ...
    <style>
        ...
        .sidebar-glow {
            box-shadow: 20px 0 80px -20px rgba(16, 185, 129, 0.15);
        }
        ...
        <aside class="w-80 hidden md:flex flex-col z-30 relative sidebar-glow border-r border-white/5">
            ...
            <div class="p-10 pb-6 text-center lg:text-left">
                <div class="flex items-center gap-4 group cursor-pointer justify-center lg:justify-start">
                    <div class="w-14 h-14 rounded-[2rem] bg-gradient-to-tr from-emerald-600 via-teal-600 to-cyan-600 flex items-center justify-center text-white font-black text-2xl shadow-2xl shadow-emerald-500/20 group-hover:rotate-[15deg] transition-all duration-700">
                        M
                    </div>
                    <div>
                        <span class="text-3xl font-black tracking-tighter header-accent-text block header-glow">SIAkad</span>
                        <span class="text-[9px] font-black text-emerald-400/40 uppercase tracking-[0.4em]">Student Console v2.0</span>
                    </div>
                </div>
            </div>
            ...
            <nav class="flex-1 mt-10 px-8 space-y-2 overflow-y-auto main-content pb-20">
                ...
                <a href="{{ route('student.dashboard') }}"
                   class="sidebar-item {{ request()->routeIs('student.dashboard') ? 'active-vivid active-vivid-emerald' : '' }} !py-4 !px-6 !rounded-3xl hover:bg-white/[0.03] transition-all duration-500">
                    <div class="icon-box !w-10 !h-10 !rounded-2xl !bg-emerald-600/10 !text-emerald-400">
                ...
                <a href="{{ route('student.attendance.history') }}"
                   class="sidebar-item {{ request()->routeIs('student.attendance.history') ? 'active-vivid active-vivid-cyan' : '' }} !py-4 !px-6 !rounded-3xl hover:bg-white/[0.03] transition-all duration-500">
                    <div class="icon-box !w-10 !h-10 !rounded-2xl !bg-cyan-600/10 !text-cyan-400 text-cyan-400">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                    </div>
                    <span class="text-[11px] font-black tracking-[0.2em]">RIWAYAT ABSEN</span>
                </a>
            ...
            <div class="p-8">
                <div class="bg-white/[0.02] border border-white/[0.03] p-5 rounded-[2.5rem] flex items-center justify-between group cursor-pointer hover:bg-white/[0.05] transition-all duration-500">
                    <div class="flex items-center gap-4">
                        <div class="relative">
                            <img class="h-12 w-12 rounded-2xl object-cover ring-4 ring-emerald-500/10 group-hover:ring-emerald-500/30 transition-all duration-500" src="{{ Auth::user()->avatar ? asset('storage/' . Auth::user()->avatar) : 'https://ui-avatars.com/api/?name='.urlencode(Auth::user()->name).'&background=10b981&color=fff' }}">
                        ...
                        <div>
                            ...
                            <div class="text-[8px] font-black text-emerald-400/60 uppercase tracking-[0.3em]">Student Active</div>
                        </div>
                    </div>
        ...
        <div class="flex-1 flex flex-col overflow-hidden relative">
            ...
            <header class="h-24 flex items-center justify-between px-10 z-20 glass-nav">
                <div class="flex items-center gap-6">
                    ...
                    <div>
                        <h1 class="text-[10px] font-black text-emerald-400/50 uppercase tracking-[0.6em] hidden sm:block">Control Panel / <span class="text-emerald-400">@yield('page_title', 'Root')</span></h1>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-8 text-white">
                    <div class="hidden lg:flex items-center gap-4 px-6 py-2 bg-white/[0.02] border border-white/[0.03] rounded-full">
                        ...
                        <span class="text-[9px] font-bold text-emerald-200/40 uppercase tracking-[0.3em]">Authorized Session</span>
                    </div>
                    ...
                    <div class="flex items-center gap-4">
                        <a href="{{ route('profile.edit') }}" class="flex items-center gap-4 bg-white/5 p-2 pr-6 rounded-2xl hover:bg-white/10 transition-all duration-500 border border-white/[0.03]">
                            <div class="w-10 h-10 rounded-xl bg-gradient-to-tr from-emerald-600 to-teal-600 flex items-center justify-center text-white shadow-xl">
