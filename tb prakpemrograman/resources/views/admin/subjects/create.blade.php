...
<div class="mb-8">
    <div class="flex items-center gap-4 mb-2">
        ...
        <h2 class="text-3xl font-extrabold text-gray-800 dark:text-gray-100">Tambah Mata Kuliah</h2>
    </div>
    <p class="text-gray-600 dark:text-gray-400 ml-12">Masukkan detail mata kuliah baru ke dalam sistem.</p>
</div>
...
<div class="glass-card p-8 max-w-2xl mx-auto">
    <form action="{{ route('admin.subjects.store') }}" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <input type="text" name="code" class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 font-bold text-gray-800 focus:ring-2 focus:ring-indigo-500 focus:outline-none transition-all shadow-sm" placeholder="Contoh: MK001" value="{{ old('code') }}" required>
        ...
        <div>
            ...
            <input type="text" name="name" class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 font-bold text-gray-800 focus:ring-2 focus:ring-indigo-500 focus:outline-none transition-all shadow-sm" placeholder="Contoh: Pemrograman Web" value="{{ old('name') }}" required>
        ...
        <div>
            ...
            <input type="number" name="sks" class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 font-bold text-gray-800 focus:ring-2 focus:ring-indigo-500 focus:outline-none transition-all shadow-sm" placeholder="Contoh: 3" value="{{ old('sks') }}" required min="1">
