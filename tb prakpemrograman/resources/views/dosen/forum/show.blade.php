...
@section('content')
<div class="mb-6">
    <a href="{{ route('dosen.forum.index', $course->id) }}" class="text-indigo-600 hover:text-indigo-800">&larr; Back to Forum</a>
</div>
...
<div class="ml-8 space-y-4">
    ...
    <div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm mt-4">
        <form action="{{ route('dosen.forum.store', $course->id) }}" method="POST">
            @csrf
