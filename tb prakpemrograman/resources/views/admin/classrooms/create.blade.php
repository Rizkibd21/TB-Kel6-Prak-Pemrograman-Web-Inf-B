...
<div class="mb-8">
    <div class="flex items-center gap-4 mb-2">
        ...
        <h2 class="text-3xl font-extrabold text-gray-800 dark:text-gray-100">Tambah Kelas Baru</h2>
    </div>
    <p class="text-gray-600 dark:text-gray-400 ml-12">Buat kelas baru dan tentukan dosen wali.</p>
</div>
...
<div class="glass-card p-8 max-w-2xl mx-auto">
    <form action="{{ route('admin.classrooms.store') }}" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <input type="text" name="name" class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 font-bold text-gray-800 focus:ring-2 focus:ring-indigo-500 focus:outline-none transition-all shadow-sm" placeholder="Contoh: IF-01" value="{{ old('name') }}" required>
